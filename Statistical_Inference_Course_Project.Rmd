...
This project contains two parts. The purpose of the first part of the project is to investigate the exponential distribution in R and compare it with the Central Limit Theorem (CLT). In the second part of this project, we will investigate and analyze the ToothGrowth data in the R datasets package. In this part, we will design a hypothesis test to compare tooth growth by supplement and dose. After conducting the appropriate statistical test, we will evaluate our hypothesis and state our conclusion based on the results. 
